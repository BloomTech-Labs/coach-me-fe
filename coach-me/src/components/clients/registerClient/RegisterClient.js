  ...
  return(
    ...
    <Form>
      <div>
        ...
        <div>
        <label>Phone#:</label>
        {touched.phonenumber && errors.segment && <p>{errors.segment}</p>}
        <Field className="input" type="text" name="phonenumber" placeholder="phonenumber" />
      </div>
...
const  RegisterFormik = withFormik({
  ...
  handleSubmit(values, { setStatus,resetForm,props}) {
    ...
    axios.post('https://api.airtable.com/v0/appcGDj4SuiTu3Nte/Master ?api_key=keytu1to8j0ODW8sD',data, {headers:headers} ).then( res =>{
      console.log(res)
      }).catch(err =>{
        console.log(err)
      })
