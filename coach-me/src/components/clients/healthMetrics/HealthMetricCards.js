        ...
        <div className="back-btn-container">
          <div className="back-button" onClick={() => handleClick()}>
            <div className="icon-back">
              <img className="icon" alt="Back Arrow" src={iconback}></img>
            </div>
            <p>{translate('back')}</p>
          </div>
        </div>
          ...
          {reverseClientData.map((record, index) => (
            <div className="health-card">
              ...
              <div className="health-label">
                ...
                <h4>{moment(record.fields.Date_time).format('MMM Do YYYY')}</h4>
              </div>
              <div className="health-metric-value">
                ...
                <h4 className="health-scale">{props.historyScale}</h4>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="metric-container">
        ...
        <div className="health-cards-container">
          {reverseClientData.map((record, index) => (
            <div className="health-card">
              <div className="metric-icon">
                <img className="icon" alt="Weight Icon" src={iconweight}></img>
              </div>
              <div className="health-label">
                <div className="label-container">
